...
class qa_html_theme_base
{
	...
	public function main()
	{
		...
		if($urlnya=="/index.php?qa=register&to=index.php"){
			echo "
			<button id='btnrendoreg'>Klik ini dahulu sebelum mendaftar</button>
			<script>
				let btn = document.getElementById('btnrendoreg');
				btn.addEventListener('click', () => {
				document.getElementById('doregisterbkb').style.display = 'none';
				document.getElementById('doregisterbkb').setAttribute('name','doregister');
				document.getElementById('btnrendoreg').style.display = 'none';
